...
class CallICFGNode(ICFGNode):
    ...
    def get_called_function(self) -> FunObjVar: ...
...
class ICFG:
    ...
    def get_fun_entry_icfg_node(self, fun: 'FunObjVar') -> FunEntryICFGNode: ...
...
class SVFVar:
    ...
    def get_in_edges(self) -> List['SVFStmt']: ...

    def get_out_edges(self) -> List['SVFStmt']: ...
...
class SVFIR(SVFLLVMValue):
    ...
    def get_fun_obj_var(self, fun_name: str) -> FunObjVar: ...
    """Get the function object variable with the given name"""

    def get_fun_ret(self, fun: FunObjVar) -> SVFVar: ...
...
# __init__.py
def get_pag(bitcodePath, *args, **kwargs) -> SVFIR: ...
...
class AbstractState:
    ...
    def get_id_from_addr(self, addr: int) -> int: ...
    def top(self) -> None: ...
    def get_element_index(self, gep: 'GepStmt') -> IntervalValue: ...
    def get_byte_offset(self, gep: 'GepStmt') -> IntervalValue: ...
    def get_gep_obj_addrs(self, ptr: int, offset: IntervalValue) -> AddressValue: ...
    def get_pointee_element_type(self, var_id: int) -> SVFType: ...
    def is_addr(self, var_id: int) -> bool: ...
    def is_interval(self, var_id: int) -> bool: ...
    def is_virtual_mem_address(self, val: int) -> bool: ...
    def get_virtual_mem_address(self, idx: int) -> int: ...
    def is_cmp_branch_feasible(self, cmp: 'CmpStmt', succ: int, abstract_state: AbstractState) -> bool: ...
    def is_switch_branch_feasible(self, switch_var: SVFVar, succ: int, abstract_state: AbstractState) -> bool: ...
    def store_value(self, varId: int, val: AbstractValue) -> None: ...
    ...
    @staticmethod
    def is_null_mem(self, addr: int) -> bool: ...
    @staticmethod
    def is_invalid_mem(self, addr: int) -> bool: ...
