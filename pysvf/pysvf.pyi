...
class TCT:
    ...
    def __init__(self, pta: 'AndersenWaveDiff') -> None: ...
    def __init__(self, pta: 'Steensgaard') -> None: ...
    def getThreadCallGraph(self) -> 'ThreadCallGraph': ...

class MHP:
    def __init__(self, tct: 'TCT') -> None: ...
    def mayHappenInParallel(self, icfg_node_id1: int, icfg_node_id2: int) -> bool: ...
