...
class SVFG(VFG):
    ...
    def getDefSiteOfValVar(self, var: ValVar) -> ICFGNode: ...
    """Get the definition site of a value variable"""
    def getDefSiteOfObjVar(self, obj: ObjVar, node: ICFGNode) -> ICFGNode: ...
    """Get the definition site of an object variable"""
    def getUseSitesOfValVar(self, var: ValVar) -> List[ICFGNode]: ...
    """Get the use sites of a value variable"""
    def getUseSitesOfObjVar(self, obj: ObjVar, node: ICFGNode) -> List[ICFGNode]: ...
    """Get the use sites of an object variable"""
...
class AbstractStateManager:
    """Manages abstract states across ICFG nodes and provides the
    sparsity-aware GEP / load / store / size helpers that used to live on
    AbstractState (moved upstream by the Semi-Sparse refactor)."""

    def __init__(self, svfir: 'SVFIR', pta: 'AndersenWaveDiff') -> None: ...

    def getAbstractValue(self, var: 'SVFVar', node: 'ICFGNode') -> AbstractValue: ...
    def hasAbstractValue(self, var: 'SVFVar', node: 'ICFGNode') -> bool: ...
    def updateAbstractValue(self, var: 'SVFVar', val: AbstractValue, node: 'ICFGNode') -> None: ...

    def getAbstractState(self, node: 'ICFGNode') -> AbstractState: ...
    def hasAbstractState(self, node: 'ICFGNode') -> bool: ...
    def updateAbstractState(self, node: 'ICFGNode', state: AbstractState) -> None: ...
    ...
    def getUseSitesOfObjVar(self, obj: 'ObjVar', node: 'ICFGNode') -> set: ...
    def getUseSitesOfValVar(self, var: 'ValVar') -> set: ...
    def getDefSiteOfValVar(self, var: 'ValVar') -> 'ICFGNode': ...
    def getDefSiteOfObjVar(self, obj: 'ObjVar', node: 'ICFGNode') -> 'ICFGNode': ...


class AbstractInterpretation:
    """Minimal binding -- exposes getStateMgr() so Python can grab the
    AbstractStateManager from a running analysis."""

    def getStateMgr(self) -> AbstractStateManager: ...
